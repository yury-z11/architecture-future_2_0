...
Проектная работа 11-го спринта по кейсу компании **«Будущее 2.0»**. 
Решение описывает целевую архитектуру работы с данными, доменное разделение, технологический радар, роадмап изменений и пример облачной инфраструктуры на Terraform.
(добавлены скриншоты прямо в тело readme для 3 и 4 задачи - все заработало в облаке Яндекса корректно. terraform.tfvars и другие файлы настроек с секретами в гитхаб не размещал (согласно заданию).
...
Скриншот успешного `terraform apply` ниже.

## Скриншоты результатов

### Task3 — Технологический радар

[Открыть скриншот техрадара](Task3/techradar_1.png)

![Технологический радар](Task3/techradar_1.png)

### Task4 — Terraform apply

[Открыть скриншот успешного Terraform apply](Task4/terraform_apply_result.png)

![Terraform apply result](Task4/terraform_apply_result.png)
